...
%     \begin{itemize}
%         \item Vale 25\% da \(N_1\)
%         \item Fazer uma pesquisa sobre \textit{Equação de Bernoulli} e resolver 2 
%             problemas usando ela
%         \item Pode ser digitado ou manuscrito
%         \item Grupo de no máximo 2 alunos\footnote{Pode ser feito individual}
%         \item Entrega até o dia 22/2 na Sala de Aula
%     \end{itemize}

%     \centering\url{https://classroom.google.com/c/NjU1MDA1MTc5NTEx?cjc=ylppnvu}
% \end{frame}
