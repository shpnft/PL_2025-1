...
\begin{frame}{Forma \textit{mais simples} para calcular \(F\) e \(h_{cp}\)}
    \begin{itemize}
        \item Na seção 2.1 do livro do Brunetti é demonstrado que a força
...
\begin{frame}[plain]{}
    \centering
    \vboxcorr{85pt}{\includegraphics[width=\textwidth]{images/tabela.pdf}}
\end{frame}
...
\begin{frame}{revisão de física geral II}
     \centering
     \includegraphics[height=\textheight-28pt]{images/Captura de tela de 2025-04-08 17-56-49.png}
\end{frame}
